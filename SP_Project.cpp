...
// level unlock state
bool level1Unlocked = true, level2Unlocked = true, level3Unlocked = true;
...
void StartSelectLevel()
{
    ...
    // init pearls
    pearls[0] = { &pearlSprite1, 25.f, "Level 1", &level1Unlocked, {205.f, 75.f},  {0.13f, 0.13f}, {230.f, 100.f}, {0.12f, 0.12f} };
    pearls[1] = { &pearlSprite2, 25.f, "Level 2", &level2Unlocked, {250.f, 127.f}, {0.15f, 0.15f}, {265.f, 150.f}, {0.085f, 0.085f} };
    pearls[2] = { &pearlSprite3, 25.f, "Level 3", &level3Unlocked, {238.f, 168.f}, {0.15f, 0.15f}, {240.f, 165.f}, {0.085f, 0.085f} };

    // init ta_pearls
    ta_pearls[0] = { &ta_pearlSprite1, 25.f, "Level 1", &ta_level1Unlocked, {205.f, 75.f},  {0.13f, 0.13f}, {230.f, 100.f}, {0.12f, 0.12f} };
    ta_pearls[1] = { &ta_pearlSprite2, 25.f, "Level 2", &ta_level2Unlocked, {250.f, 127.f}, {0.15f, 0.15f}, {265.f, 150.f}, {0.085f, 0.085f} };
    ta_pearls[2] = { &ta_pearlSprite3, 25.f, "Level 3", &ta_level3Unlocked, {238.f, 168.f}, {0.15f, 0.15f}, {240.f, 165.f}, {0.085f, 0.085f} };
}
...
void UpdateSelectLevel(float dt)
{
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        p.sprite->setPosition(*p.unlocked ? p.unlockedPos : p.lockedPos);
        p.sprite->setScale(*p.unlocked ? p.unlockedScale : p.lockedScale);
        if (*p.unlocked)
...
void UpdateGameScreen()
{
    ...
    // === Hover Sound (plays once per new button) ===
    static int lastHoveredBtn = -1;
    int currentHoveredBtn = -1;
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (gsBtns[i].sprite->getGlobalBounds().contains(mousePos))
        {
            ...
            currentHoveredBtn = i; // 0 = options, 1 = quit
        }
        else
        {
    ...
    if (!showQuitPopup)
    {
        // Play sound once when entering a new button
        if (currentHoveredBtn != lastHoveredBtn && currentHoveredBtn != -1)
        {
            buttonpressedsound.play();
        }
        lastHoveredBtn = currentHoveredBtn;
        return;
    }
    ...
    // Play sound once when entering a new button (popup)
    if (currentHoveredBtn != lastHoveredBtn && currentHoveredBtn != -1)
    {
        buttonpressedsound.play();
    }
